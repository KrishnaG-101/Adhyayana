...
## Active Assignments
- **Teammate 1**: Monorepo Scaffolding & Documentation Review
- **Teammate 2**: Environment Configuration & Dependency Audits
...
- [ ] Initialize backend `requirements.txt` & FastAPI `main.py`
